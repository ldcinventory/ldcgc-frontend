...
export function AppButton({ children, onClick, className, disabled }: Button) {
  return (
    <button onClick={onClick}
      className={`bg-primary-2 rounded-md p-1 hover:bg-primary-4 transition-all duration-300 dark:bg-primary-7 hover:dark:bg-primary-6
      ${className}`}
      disabled={disabled}>
      {children}
    </button>
...
export function AppButtonRounded({ children, onClick, className, disabled }: Button) {
  return (
    <button onClick={onClick}
      className={`bg-primary-2 rounded-full p-1 hover:bg-primary-4 transition-all duration-300 dark:bg-primary-7 hover:dark:bg-primary-6
      ${className}`}
      disabled={disabled}>
      {children}
    </button>
