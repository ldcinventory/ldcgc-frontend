          ...
          {state.consumables.map(consumable =>
            <tr key={consumable.id} className="align-top">
              ...
              <AppTableCell columns={2} className="justify-end">
                <AppNavLink to={`/resources/consumables/${consumable.barcode}`} className="bg-primary-3 p-1 rounded-md"><PencilIcon className="h-5" /> </AppNavLink>
        ...
        <tbody>
          {state.consumables.map(consumable =>
            <tr key={consumable.id} className="align-top">
              ...
              <AppTableCell columns={4}>
                <AppNavLink to={`/resources/consumables/${consumable.barcode}`} className="bg-primary-3 p-1 rounded-md"><PencilIcon className="h-6" /> </AppNavLink>
                <AppButtonError onClick={() => handleOpenDeleteConsumableModal(consumable)}>
