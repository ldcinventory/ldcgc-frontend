  ...
  return (
    <>
      ...
      <section className={`bg-primary-9 absolute w-full h-screen top-0 left-0 bg-opacity-50 flex items-center ${!modalOpened && 'hidden'}`}>
        <form className="w-4/5 sm:w-2/3 lg:w-1/3 transition-all m-auto bg-primary-2 py-4 px-6 rounded-lg z-10 flex flex-col gap-4" onSubmit={handleAddVolunteer} id="addVolunteerForm">
